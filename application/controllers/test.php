...
public function BonjourAvecParametres($nom = 'Anonyme')
{
$DonneesInjectees['nomDeLaPersonne'] = $nom;
$this->load->view('test/BonjourAvecParametres',$DonneesInjectees); // injection du tableau
}
...
$this->load->view('test/BonjourAvecParametres',$DonneesInjectees);
}
