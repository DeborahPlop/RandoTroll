...
<?php 
    ...
    foreach ($Equipes as $uneEquipe):
        ...
        $this->table->add_row($uneEquipe['NOMEQUIPE'],$uneEquipe['PRENOM']." ".$uneEquipe['NOM'],$uneEquipe['TELPORTABLE'],$uneEquipe['MAIL'],$Format_Du." €",$Format_APayer." €",$uneEquipe['MODEREGLEMENT'],form_submit('submit','Modifier')); //Trouver comment faire passer une valeur par ce bouton ? 
        $i += 1 ;
        endforeach  ;
